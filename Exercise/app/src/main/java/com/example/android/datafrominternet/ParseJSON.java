...
//        JSONObject hourly = (JSONObject) Weather.getJSONArray("hourly").get(0);
        JSONObject lifestyle = (JSONObject) Weather.getJSONArray("lifestyle").get(1);

        weatherdata.put("tmp_max",daily_forecast.getString("tmp_max"));
        weatherdata.put("tmp_min",daily_forecast.getString("tmp_min"));
        weatherdata.put("cond_code_d",daily_forecast.getString("cond_code_d"));
        weatherdata.put("cond_code_n",daily_forecast.getString("cond_code_n"));
        weatherdata.put("date",daily_forecast.getString("date"));
        ...
        weatherdata.put("brf",lifestyle.getString("brf"));
        weatherdata.put("txt",lifestyle.getString("txt"));
